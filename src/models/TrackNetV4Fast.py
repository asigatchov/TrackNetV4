...
def TrackNetV4Fast(input_height, input_width, fusion_layer_type="TypeA"):
    """
    Builds the TrackNetV4Small model with Depthwise Separable Convolutions for improved performance on OpenVINO GPU.
    ...
    Returns:
        Model: A Keras model instance optimized with Depthwise Separable Convolutions.
    """
